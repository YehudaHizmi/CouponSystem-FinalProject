...
public class CustomerFacade implements ClientFacade {
	...
	*/
	...
	/**
	 * 
	 * This method activate the getCoupons method at the couponDaoDb class.
	 * @return - Return a collection of all the available coupons
	 * @throws CouponSystemException - throws an exception with the message "There aren't any listed coupons in the system"
	 */
...
/*	public Collection<Coupon> getAllPurchasedCouponsByPrice(double price) throws CouponSystemException{
	...
	*/
	...
	/**
	 * This method return the logged in customer information  
	 * @return - The customer that is logged in as an object
	 * @throws CouponSystemException throws an exception that is has thrown from other methods
	 */
	public Customer viewCustomerInfromation() throws CouponSystemException{
		//Since the customer who activate this method already logged in there aren't any checks to do 
		return customerDaoDb.getCustomer(this.customer.getId());
	}
