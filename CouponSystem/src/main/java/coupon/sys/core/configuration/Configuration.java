...
//		this.DB_URL = "jdbc:derby://localhost:1527/CouponSystem;create=false";
		this.DB_URL = "jdbc:derby:CouponSystem;create=false";
//		this.DRIVER = "oracle.jdbc.driver.OracleDriver";
		this.DRIVER = "orf.apache.driver.OracleDriver.EmbeddedDriver";
